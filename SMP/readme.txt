...
This is a small list of steps in order to build libgpg-error into a msvc dll and/or lib file.
...
The project configurations support being built with various different windows SDK versions.
  ...
  (libgpg-error_with_latest_sdk.bat) which can be used to auto detect the newest available SDK
...
The build system requires several of the .h files to be built automatically. This should have already been done and the resulting
...
In order for new files to be generated the project needs access to 'awk'. Ensure that Gawk is accessible by Visual Studio.

Gawk can be downloaded from here:
http://gnuwin32.sourceforge.net/packages/gawk.htm

Pre-built windows binaries can also be found in the above link. To enable generation of new files awk.exe should be extracted 
